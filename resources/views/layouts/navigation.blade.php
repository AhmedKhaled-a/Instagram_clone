<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('posts.index') }}">
                        ...
                        <img src="{{ asset('app logo/nav-logo.png') }}" alt="instagram logo" class=""
                            style="width: 90px">
                    </a>
                </div>
            ...
            @guest
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex flex-wrap flex-row justify-content-between align-items-center">
                    @if (Route::has('login'))
