    ...
    <ul>
        ...
        <li class="has-subnav mb-3">
            <a href="{{ route('saved-posts.show') }}" class="">
                <i class="fa fa-bookmark fa-2x fs-4 mt-3"></i>
                <span class="nav-text">
                    Saved Posts
                </span>
            </a>
