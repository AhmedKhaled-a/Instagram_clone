...
@if($currentUser->following->count() <= 0 )
    <div class="shadow-md rounded p-5 container"> 
        <h1 class="fw-light">Follow someone <i class="fa-regular fa-face-smile-wink"></i></h1>
        <form action="{{ route("user.index")}}">
            <button type="submit" class="d-block mt-3 mx-auto btn btn-outline-dark btn-lg">Search Users</button>
        </form>
    </div>
@else
