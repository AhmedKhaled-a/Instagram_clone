...
<div class="container post-container">
    ...
    <span id="username" class="d-none" data-user-avatar="{{ Auth::user()->avatar }}">{{ Auth::user()->name }}</span>
    ...
    <div class="comments-container flex-column align-items-end" style="max-height: 400px; overflow-y: auto;">
        <div class="post-header">
            <img src="{{ Storage::disk('public')->url($post->user->avatar) }}" alt="User Image">
        ...
        @foreach($post->comments->reverse() as $comment)
            <div class="comment">
                <div class="d-flex mb-3">
                    <img src="{{ Storage::disk('public')->url($comment->user->avatar) }}" alt="" class='w-10 rounded-circle'>
        ...
        <div id="postForm" class="comment-form mt-3">
